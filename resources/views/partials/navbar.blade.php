<nav class="fixed top-0 w-full z-50 bg-[#b5106a] backdrop-blur-xl">
    <div class="flex justify-between items-center px-8 py-4 max-w-screen-2xl mx-auto">
        ...
        <div class="flex items-center gap-6">
            ...
            @guest
                <button onclick="toggleModal()" class="text-white font-medium hover:text-gray-200 transition-colors">Login</button>
        ...
        if (profileBtn && profileMenu) {
            ...
            profileBtn.addEventListener('click', function(e) {
                ...
                if (profileMenu.classList.contains('hidden')) {
                    ...
                    // Tiny delay to allow the DOM to render 'block' before applying opacity transition
                    setTimeout(() => {
                    ...
                    }, 200); // Matches the duration-200 Tailwind class
                }
            });
