@php
    // Fetch only the services for this specific category
    $categoryServices = \App\Models\Service::where('category', 'Nail Care')->get();
@endphp
...
<section class="py-8 px-4">
    ...
    <div class="mb-12 text-center">
        ...
        <p class="text-on-surface-variant mt-4 font-body italic max-w-lg mx-auto">
            Indulge in our signature hand and foot treatments.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        @forelse($categoryServices as $service)
            {{-- Dynamic Card using your original styling --}}
