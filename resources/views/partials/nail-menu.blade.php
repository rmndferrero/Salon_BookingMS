<section id="nail-care-menu" class="mt-32 py-16 px-8 max-w-4xl mx-auto bg-white/30 rounded-3xl backdrop-blur-sm">
    <div class="mb-12 border-b border-primary/10 pb-6">
        <h2 class="font-headline text-4xl text-on-surface">Nail Care Menu</h2>
        <p class="text-on-surface-variant mt-2 font-body italic">Indulge in our signature hand and foot treatments.</p>
    </div>
