...
<footer class="bg-[#f4f3f2] pt-20 pb-10 border-t border-stone-200">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 max-w-7xl mx-auto">
        ...
        <div class="col-span-1">
            ...
            <a href="https://maps.google.com/?q=Al+Hashar+Building+Dubai" target="_blank" class="text-[#b5106a] text-xs font-bold uppercase tracking-widest hover:underline">
                Get Directions →
            </a>
        </div>
...
>>>>>>> 4554991 (Update footer and services carousel)
        <div>
        ...
        <div>
            ...
            <div class="flex gap-4">
                ...
                <a href="https://www.facebook.com/profile.php?id=61584300861932" 
                   ...
                   class="h-10 w-10 rounded-full bg-white flex items-center justify-center text-[#b5106a] shadow-sm hover:scale-110 hover:bg-[#b5106a] hover:text-white transition-all">
                    <span class="material-symbols-outlined text-lg">face</span>
                </a>
            ...
            <p class="text-stone-400 text-xs mt-6 leading-relaxed">
